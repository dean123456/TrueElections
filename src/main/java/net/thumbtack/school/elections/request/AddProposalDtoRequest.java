...
public class AddProposalDtoRequest implements Serializable {
    ...
    public AddProposalDtoRequest(String token, String proposalTitle){
    ...
    public AddProposalDtoRequest validate() throws ElectionJsonParsingException {
